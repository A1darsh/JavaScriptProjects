...
let mic = document.getElementById("mic"),
  chatareamain = document.querySelector(".chatarea-main"),
  chatareaouter = document.querySelector(".chatarea-outer");
...
const name = localStorage.getItem("name") || "my friend",
  ...
  intro = ["Hello, I am Hope", "Hello, My name is Hope", "My name is Hope"],
  help = [
  ...
  bye = ["Goodbye!", "Goodbye, take care!", "Goodbye, see you soon!"],
  morning = [
...
function chatbotvoice(message) {
  ...
  if (((speech.text = finalbackup), message.includes("who are you"))) {
  ...
  if (
    (message.includes("okay") && (speech.text = "Okay."),
    message.includes("ok") && (speech.text = "Okay."),
    message.includes("you matter") &&
      (speech.text =
  ...
  if (
    (message.includes("birthday to you") &&
      (speech.text =
  ...
  if (
    (message.includes("your favourite colour") &&
      (speech.text = "Infrared is super pretty."),
    message.includes("your favorite color") &&
      (speech.text = "Infrared is super pretty."),
    message.includes("fight me") && (speech.text = "I'll pass, thanks."),
    message.includes("are you smart") && (speech.text = "I try my best."),
    message.includes("you happy") &&
      (speech.text = "I'm happy when I'm helping you."),
    message.includes("when you grow up") &&
      (speech.text = "I want to be the computer from Star Trek."),
    message.includes("who's better you or") &&
      (speech.text = "I like all AIs."),
    message.includes("are you stupid") &&
      (speech.text = "No, but I am always learning more."),
    message.includes("who's your daddy") && (speech.text = "Jericho"),
  ...
  if (
    (message.includes("use the force") &&
      (speech.text = "Can I borrow a lightsaber?!"),
    message.includes("pineapple under the sea") &&
      (speech.text = "Spongebob Squarepants."),
    message.includes("i'll be back") && (speech.text = "Hasta la vista, baby."),
    message.includes("want to build a snowman"))
  ) {
  ...
  if (
    (message.includes("live long and prosper") &&
      (speech.text = "Peace and long life."),
    message.includes("where is gamora") && (speech.text = "WHY IS GAMORA?"),
    message.includes("fairest of them all") &&
      (speech.text =
        "Famed is thy beauty, majesty. But hold, a lovely maid I see. Rags cannot hide her gentle grace. Alas, she is more fair than me."),
    message.includes("the dogs out") && (speech.text = "Who, who, who, who?"),
    message.includes("give you up") &&
      (speech.text = "Thanks, Rick, that is good to know. Roll on now."),
    message.includes("twinkle little star") &&
      (speech.text = "How I wonder what you are."),
    message.includes("the real life") &&
      (speech.text =
  ...
  if (
    ...
    message.includes("hug"))
  ) {
    let finalresult = hug[Math.floor(Math.random() * hug.length)];
    speech.text = finalresult;
  }
  if (
    (message.includes("sandwich") && (speech.text = "OK, you're a sandwich."),
    message.includes("live in a society") &&
      (speech.text = "Where honor is a distant memory"),
    message.includes("interesting fact"))
  ) {
  ...
  if (
    (message.includes("testing") && (speech.text = "Receiving, over."),
    message.includes("mic test"))
  ) {
    let finalresult = micTest[Math.floor(Math.random() * micTest.length)];
    speech.text = finalresult;
  }
  if (
    (message.includes("marco") && (speech.text = "Polo."),
    message.includes("00100") &&
      (speech.text =
        "Destruct sequence completed and engaged. Awaiting final code for countdown.."),
    message.includes("11100"))
  ) {
    let finalresult = destruct[Math.floor(Math.random() * destruct.length)];
    speech.text = finalresult;
  }
  if (
    (message.includes("would a woodchuck chuck") &&
      (speech.text =
        "He would chuck, he would, as much as he could, and chuck as much wood as a woodchuck would if a woodchuck could chuck wood."),
    message.includes("How much wood would") &&
      (speech.text =
        "He would chuck, he would, as much as he could, and chuck as much wood as a woodchuck would if a woodchuck could chuck wood."),
    message.includes("twister"))
  ) {
  ...
  message.includes("show all commands") &&
    (speech = document.querySelector(".skill-list-container").style.display =
      "block"),
    message.includes("show all command") &&
      (speech = document.querySelector(".skill-list-container").style.display =
        "block"),
    message.includes("show commands") &&
      (speech = document.querySelector(".skill-list-container").style.display =
        "block"),
    message.includes("show command") &&
      (speech = document.querySelector(".skill-list-container").style.display =
        "block"),
    message.includes("open command") &&
      (speech = document.querySelector(".skill-list-container").style.display =
        "block"),
    message.includes("open commands") &&
      (speech = document.querySelector(".skill-list-container").style.display =
        "block"),
    message.includes("open p******") &&
      (speech.text = "What are you doing step bro?"),
    message.includes("google") &&
      (speech = (function google() {
        window.open("https://www.google.com/");
      })()),
    message.includes("youtube") &&
      (speech = (function youtube() {
        window.open("https://www.youtube.com/");
      })()),
    message.includes("twitter") &&
      (speech = (function twitter() {
        window.open("https://www.twitter.com/");
      })()),
    message.includes("instagram") &&
      (speech = (function instagram() {
        window.open("https://www.instagram.com/");
      })()),
    message.includes("github") &&
      (speech = (function github() {
        window.open("https://www.github.com/");
      })()),
    message.includes("gmail") &&
      (speech = (function gmail() {
        window.open("https://www.gmail.com/");
      })()),
    message.includes("facebook") &&
      (speech = (function facebook() {
        window.open("https://www.facebook.com/");
      })()),
    message.includes("spotify") &&
      (speech = (function spotify() {
        window.open("https://www.spotify.com/");
      })()),
    message.includes("wikipedia") &&
      (speech = (function wikipedia() {
        window.open("https://www.wikipedia.com/");
      })()),
    message.includes("w3school") &&
      (speech = (function w3schools() {
        window.open("https://www.w3schools.com/");
      })()),
    message.includes("stack overflow") &&
      (speech = (function stackoverflow() {
      ...
      (speech.text =
        ...
        (function getReadableTime() {
          var d = new Date(),
            ...
            isAfterNoon = !1;
          return (
            hour >= 12 && ((isAfterNoon = !0), hour >= 13 && (hour -= 12)),
    ...
    message.includes("suicide") && (speech = suicide()),
    message.includes("kill myself") && (speech = suicide()),
    message.includes("i want to die") && (speech = suicide()),
    message.includes("depression") && (speech = suicide()),
    message.includes("rape") && (speech = rape()),
    message.includes("raped") && (speech = rape()),
    (speech.volume = 1),
    (speech.rate = 1),
    (speech.pitch = 1),
...
(recognition.onresult = function (e) {
  ...
  (recognition.onend = function () {
    (mic.style.background = "#ff3b3b"), endAudio.play();
  }),
